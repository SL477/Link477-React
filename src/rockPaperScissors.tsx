    ...
    <div className="text-center">
      <p>
        ...
        <a
          target="_blank"
          rel="noopener"
          href="https://www.theodinproject.com/paths/foundations/courses/foundations/lessons/rock-paper-scissors"
        >
